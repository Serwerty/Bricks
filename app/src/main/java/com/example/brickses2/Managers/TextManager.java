...
public class TextManager {
    ...
    public void Draw(float[] m) {
        ...
        int mPositionHandle = GLES20.glGetAttribLocation(ShaderTools.sp_Text,
                "vPosition");
        ...
        int mTexCoordLoc = GLES20.glGetAttribLocation(ShaderTools.sp_Text,
                "a_texCoord");
        ...
        int mColorHandle = GLES20.glGetAttribLocation(ShaderTools.sp_Text,
                "a_Color");
        ...
        int mtrxhandle = GLES20.glGetUniformLocation(ShaderTools.sp_Text,
                "uMVPMatrix");

        // Apply the projection and view transformation
        GLES20.glUniformMatrix4fv(mtrxhandle, 1, false, m, 0);

        int mSamplerLoc = GLES20.glGetUniformLocation(ShaderTools.sp_Text,
                "s_texture");
